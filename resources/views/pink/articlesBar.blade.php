            ...
            <div class="recent-post recent-comments group">
                @foreach($comments as $comment)
                    <div class="the-post group">
                        ...
                        <span class="author">{{ isset($comment->user) ? $comment->user->name : $comment->name}} in</span>
                        <a class="title" href="{{ route('articles.show', ['alias' => '$comments->article->alias']) }}">{{ $comment->article->title }}</a>
                        <p class="comment">
