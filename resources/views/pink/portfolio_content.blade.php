...
<div id="content-page" class="content group">
    ...
    <div class="posts">
        <div class="group portfolio-post internal-post">
            ...
            {{--filtric info vercnelu hamar controleri mej load() functian chi kanchvel vorovhetev ays depqum el, load-i depqum el kstexcvi 1 hat sql query--}}
            {{--vorovhetev nkarvum e mi hat portfolio,, optimizaciayi xndir chka                                --}}
