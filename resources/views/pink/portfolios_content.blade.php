                    ...
                    <div class="hentry work group">
                        ...
                        <div class="work-description">
                            ...
                            <div class="work-skillsdate">
                                ...
                                <p class="workdat"><span class="label">Customer:</span> {{ $portfolio->customer }}</p>

                                @if($portfolio->created_at)
                                    <p class="workdat"><span class="label">Year:</span> {{ $portfolio->created_at->format('Y') }}</p>
                                    @endif
                            </div>
                    ...
                    <div class="general-pagination group">
                        @if($portfolios->lastPage() > 1)
                            ...
                            @if($portfolios->currentPage() != 1)
                                <a href="{{ $portfolios->url($portfolios->currentPage() - 1) }}">{{ Lang::get('ru.previous') }}</a>
                            @endif
                            ...
                            @endfor
                                ...
                                @if($portfolios->currentPage() != $portfolios->lastPage())
                                    <a href="{{ $portfolios->url($portfolios->currentPage() + 1) }}">{{ Lang::get('ru.next') }}</a>
                                @endif
