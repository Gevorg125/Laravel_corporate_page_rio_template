<div id="content-single" class="content group">
    ...
    <div id="comments">
        ...
        {{--kstexcvi $com popoxakan vorin kveragrvi @set-i erkrord argument@ group_by functiayov kdasavorvi @st parent_id-i patkanelutyan--}}
        ...
        <div id="respond">
            ...
            {{--AJAX file@ public/pink/js/myscript--}}
